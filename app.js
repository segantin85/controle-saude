...
function toggleRegister(){
  ...
  const opening = box.classList.contains("is-collapsed");
  if(opening){
...
document.querySelectorAll("nav button").forEach(b=>b.onclick=()=>openTab(b.dataset.t));$("gear").onclick=()=>openTab("settings");if("serviceWorker"in navigator){
